...
const usaData = {
    ...
    travelQueries: {
        '2023': [40.62, 36.62, 39.42, 39.31, 43.77, 40.01, 44.89, 47.93, 50.44, 73.27, 50.43, 47.66],
        '2024': [51.17, 45.16, 52.90, 44.29, 48.27, 57.25, 98.08, 59.57, 59.17, 86.02, 58.28, 63.31],
        '2025': {
            'moderate': [59.96, 43.31, 57.37, 43.84, 51.79, 63.34, 158.13, 71.95, 71.42, 149.64, 71.77, 78.98],
            'conservative': [57.83, 41.77, 55.33, 42.29, 49.96, 61.10, 152.51, 69.40, 68.88, 144.30, 69.21, 76.16],
            'ambitious': [62.09, 44.85, 59.41, 45.39, 53.62, 65.58, 163.75, 74.50, 73.96, 154.98, 74.33, 81.80]
        }
    },
    flightSearches: {
        '2023': [338, 305, 299, 340, 512, 337, 262, 367, 428, 414, 475, 310],
        '2024': [464, 421, 349, 365, 407, 311, 457, 425, 575, 517, 371, 355]
    },
    hotelGuests: {
        '2023': [8588, 8509, 8577, 5920, 6867, 5264, 5138, 5620, 6961, 9796, 8908, 9653],
        '2024': [9672, 11437, 9299, 9893, 9035, 7004, 7017, 6244, 8345, 11639, 12267, 14605]
    }
};
    ...
    queriesChart = new Chart(queriesCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: '2024 Actual',
                    data: usaData.travelQueries['2024'],
        ...
        options: {
            ...
            plugins: {
                ...
                title: {
                    display: true,
                    text: 'USA Travel Queries Forecast',
                    font: {
                        family: "'Inter', sans-serif",
                        size: 16,
                        weight: 'bold'
    ...
    flightsChart = new Chart(flightsCtx, {
        ...
        data: {
            ...
            datasets: [
                {
                    label: '2023',
                    data: usaData.flightSearches['2023'],
                    borderColor: 'rgba(54, 162, 235, 1)',
                    backgroundColor: 'rgba(54, 162, 235, 0.1)',
                    borderWidth: 2,
                    fill: false
                ...
                {
                    label: '2024',
                    data: usaData.flightSearches['2024'],
                    borderColor: 'rgba(255, 159, 64, 1)',
                    backgroundColor: 'rgba(255, 159, 64, 0.1)',
                    borderWidth: 2,
                    fill: false
...
function updateQueriesChart(scenario) {
    ...
    if (scenario === 'actual') {
        ...
        queriesChart.data.datasets.push({
            label: '2023 Actual',
            data: usaData.travelQueries['2023'],
            borderColor: 'rgba(54, 162, 235, 1)',
            backgroundColor: 'rgba(54, 162, 235, 0.1)',
            borderWidth: 2,
            fill: false
